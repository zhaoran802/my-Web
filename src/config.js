const config = {
	...
	metaData: {
		title: 'Marisa X的个人主页🎉',
		description: '欢迎来到Marisa X的奇妙世界！',
		keywords: 'Marisa X,Marisa X,个人主页,个人网站',
		icon: '/favicon.ico'   //网页图标，支持外链
	},

	avatar: "https://ertyu.netlib.re/1765007243698.png", // 头像
	welcometitle: "Hi, I'm Marisa X", // 标题
	...
	background: {
		"pc": {   //pc端
			...
			"datainfo": {
				...
				"url": "https://ertyu.netlib.re/1765006572526.png",     //当然，也可填写网络地址或壁纸api，如随机PC壁纸api："url":"https://t.mwm.moe/pc"
			},
		},
		"mobile": {   //移动端
			"type": "pic",
			"datainfo": {
				...
				"url": "https://ertyu.netlib.re/1765001772485.png"  //同理，随机移动端壁纸："url":"https://t.mwm.moe/mp"
			}
		}
	...
	musicPlayer: {
		...
		type: 'playlist',   //歌单类型
		id: '17520621938'  //歌单id ---> music.163.com/playlist?id=17520621938
	},

const config = {
	...
	background: {
		"pc": {   //pc端
			...
			"datainfo": {
				"title": "高达",
				"preview": "https://ertyu.netlib.re/1765001772485.png",
				"url": "https://ertyu.netlib.re/1765001772485.png",     //当然，也可填写网络地址或壁纸api，如随机PC壁纸api："url":"https://t.mwm.moe/pc"
			},
		},
		"mobile": {   //移动端
			"type": "pic",
	...
	socialPlatformIcons: [
		...
		{ icon: "mdi-email", link: "mailto:zhaoran
			@gmail.com" },
	...
	musicPlayer: {
		...
		type: 'playlist',   //歌单类型
		id: '17520621938'  //歌单id ---> https://music.163.com/playlist?id=17520621938
	},
